...
def find_net_using_name(net_name):
    ...
    """
    net_filename = "models." + net_name + "_net"
...
def define_net(net_name, input_nc, output_nc, init_type='normal', init_gain=0.02, gpu_ids=[], opt = None):
    """
    ...
    if opt is not None:
        net = net_class(input_nc, output_nc, opt = opt)
    else:
        net = net_class(input_nc, output_nc)
